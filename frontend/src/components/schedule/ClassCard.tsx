...
import { lessonTypePillBackground } from '@/lib/utils';
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1 flex-wrap">
                <span
                  className="text-sm font-bold px-3 py-1 rounded-full text-foreground"
                  style={{
                    backgroundColor: lessonTypePillBackground(cls.color),
