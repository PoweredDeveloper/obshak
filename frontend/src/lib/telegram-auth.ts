...
import { ensureTelegramInitData, getTelegramInitDataFromPage } from '@/lib/telegram-webapp';
...
export async function getTelegramInitDataAsync(): Promise<string | null> {
  return ensureTelegramInitData();
}
